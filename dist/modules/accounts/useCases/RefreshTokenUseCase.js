...
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _IAuthenticationProvider.default === "undefined" ? Object : _IAuthenticationProvider.default, typeof _ICacheProvider.default === "undefined" ? Object : _ICacheProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = class RefreshTokenUseCase {
  ...
  async execute({
    ...
    try {
      ...
      if (fmToken) {
        const {
          email
        } = await this.authProvider.verifyToken(authReponse.accessToken);
        const {
          id
